...
export default function ArtifactExperience({ artifact }: { artifact: Artifact }) {
  ...
  return (
    <main>
      ...
      <section className="section source-section"><div className="section-heading split-heading"><div><span className="eyebrow">05 · 资料来源</span><h2>可核验，才能继续生长</h2></div><p>内容与素材分开记录来源，未经审核和授权的资料不进入正式展示。</p></div>
